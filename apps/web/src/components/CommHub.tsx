...
function ActivityCard({
  ...
  if (activity.channel === "email") {
    if (isInbound) { fromLabel = contactName; toLabel = (mRec.employee_name as string) || "OSC"; }
    else { fromLabel = (mRec.employee_name as string) || "OSC"; toLabel = contactName; }
  } else if (activity.channel === "sms" || activity.channel === "text") {
    fromLabel = isInbound ? contactName : "OSC";
    toLabel = isInbound ? "OSC" : contactName;
  } else if (activity.channel === "phone" || activity.channel === "call") {
    fromLabel = isInbound ? contactName : "OSC";
    toLabel = isInbound ? "OSC" : contactName;
  } else {
